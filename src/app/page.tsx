...
export default function Home() {
  return (
    <>
      ...
      <section
        id="hero"
        className="relative bg-gradient-to-br from-cyan via-sky-600 to-slate-900 pt-28 pb-24 px-4 overflow-hidden"
      >
        {/* Dot pattern overlay */}
      ...
      {/* Events Section */}
      <section id="events" className="py-20 px-4 bg-[#FAFAF8]" data-animate>
      ...
      {/* Submit Event CTA */}
      <section id="submit" className="py-16 px-4 bg-sky-50" data-animate>
